// Seleciona os elementods do formulario
...
function expenseAdd(newExpense) {
    try {
        ...
        // Adiciona nome e categoriana div das informaçoes das despesa.
...
function updateTotals(){
    try {
        ...
        //Variavel para inclementar o total.
        let total = 0

        //Percorre cada item do (li) da lista (ul)
        ...
        alert("Nao foi possivel carregar os totais.")
    }
}
